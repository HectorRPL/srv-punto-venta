...
import {PartidasOrdenesVentas} from "../collection";
import {Productos} from "../../../catalogos/productos/collection";

if (Meteor.isServer) {

    Meteor.publishComposite('partidasOrdenesVentas.ordenId', function (filter) {
        if (Object.keys(filter).length === 0 && filter.constructor === Object) {
            ...
            return {
                find: function () {
                    return PartidasOrdenesVentas.find(selector, options);
                },
                children: [
                    {
